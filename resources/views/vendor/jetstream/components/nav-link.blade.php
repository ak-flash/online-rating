...
$classes = ($active ?? false)
            ? 'bg-green-50 inline-flex items-center px-1 pt-1 border-b-2 border-green-600 text-sm font-medium leading-5 focus:outline-none focus:border-green-700 transition duration-150 ease-in-out px-3'
