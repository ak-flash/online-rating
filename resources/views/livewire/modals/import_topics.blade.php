<x-form-modal wire:model="openImport" :maxWidth="5">
    ...
    <x-slot name="title">
        <div class="text-sm text-justify">
            Скопируйте столбец таблицы с темами (можно прямо с цифрами, но каждое занятие должно быть с новой строки) из файла с тематическим планом и вставьте названия тем.
        </div>
    </x-slot>
