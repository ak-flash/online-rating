<div class="block relative" x-data="{search: null}">
    ...
    <input type="text" placeholder="Поиск" class="block pl-8 pr-6 py-2 w-full bg-white text-sm placeholder-gray-400 text-gray-700 border-gray-300" wire:model.debounce.500ms="search" x-ref="search" />
